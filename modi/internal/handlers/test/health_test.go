...
func setupTestRouter(handler *handlers.HealthHandler) *gin.Engine {
...
func TestHealthHandler_Health(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			handler := handlers.NewHealthHandler(db, redis)
...
func TestNewHealthHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			handler := handlers.NewHealthHandler(tt.db, tt.redis)
